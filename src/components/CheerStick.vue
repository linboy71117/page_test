    ...
    return {
      stickImages: {
        ...
        sword: {
          ...
          2: require("@/assets/sword-level-2.png"),
          3: require("@/assets/sword-level-3.png"),
          4: require("@/assets/sword-level-4.png"),
          5: require("@/assets/sword-level-5.png"),
        },
        sshadow: {
          1: require("@/assets/reciever_dark_sword.png"),
          2: require("@/assets/reciever_dark_sword.png"),
          3: require("@/assets/reciever_dark_sword.png"),
          4: require("@/assets/reciever_dark_sword.png"),
          5: require("@/assets/reciever_dark_sword.png"),
        },
        bshadow: {
          1: require("@/assets/reciever_dark_brocoli.png"),
          2: require("@/assets/reciever_dark_brocoli.png"),
          3: require("@/assets/reciever_dark_brocoli.png"),
          4: require("@/assets/reciever_dark_brocoli.png"),
          5: require("@/assets/reciever_dark_brocoli.png"),
        },
      } as StickImages,
      intervalId: 0,
      duration: 1,
